...
xmlPointer.prototype={
	...
	content:function(){return this.d.firstChild?this.d.firstChild.data:""; }, // <4k
																				// in
																				// FF
 ...
 */
   ...
   /**
	 ...
	 * @eventdesc: Event raises right before item in tree was checked/unchecked.
	 *             can be canceled (return false from event handler)
	 * @eventparam: ID of item which will be checked/unchecked
	 * @eventparam: Current checkbox state. 1 - item checked, 0 - item
	 *              unchecked.
 ...
 */
   ...
   /**
	 ...
	 *             using both onClick and onDblClick events, because component
	 *             can generate onClick event before onDblClick event while
	 *             doubleclicking item in tree. ( that behavior depend on used
	 *             browser )
	 * @eventparam: ID of item which was doubleclicked
	 * @eventreturn: true - confirm opening/closing; false - deny
	 *               opening/closing;
	 */
      ...
      var Count=targetObject.childsCount; var Nodes=targetObject.childNodes;
           ...
           Nodes[Count]=itemObject;
            ...
            if ((!oldTree.dpcpy)&&(!framesMove))   {
                ...
                else   // if (zir.parentNode)
						// zir.parentNode.removeChild(zir,true);
 ...
 */
   ...
   /**
	 ...
	 * @type: public
	 * @param: mode - enabled/disabled [ can be true/false/temporary_disabled -
	 *         last value mean that tree can be D-n-D can be switched to true
	 *         later ]
