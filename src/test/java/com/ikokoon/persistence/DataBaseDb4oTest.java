...
public class DataBaseDb4oTest extends ATest {
	...
	public void initilize() {
		System.setProperty(IConstants.INDEX_FIELDS, "false");
		super.initilize();
	}
	...
	public void findClassQueryNameParametersFirstMaxResults() {
		...
		parameters.put(PARENT, klass);
		parameters.put(DESCRIPTION, methodDescription);
		methods = dataBase.find(Method.class, Method.SELECT_METHODS_BY_NAME, parameters, 0, Integer.MAX_VALUE);
	...
	public void selectPerformance() throws Exception {
		try {
			...
			System.setProperty(IConstants.INDEX_FIELDS, "true");
			super.initilize();
