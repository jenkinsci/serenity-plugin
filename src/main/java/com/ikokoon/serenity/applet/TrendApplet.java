...
public class TrendApplet extends JApplet {
	...
	private IModel getModel() {
		IModel model = (IModel) deserializeFromBase64(Class);
		return model;
	}
